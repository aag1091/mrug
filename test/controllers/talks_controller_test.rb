...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { author_name: @talk.author_name, description: @talk.description, event_id: @talk.event_id, name: @talk.name }
    end
  ...
  test "should update talk" do
    patch :update, id: @talk, talk: { author_name: @talk.author_name, description: @talk.description, event_id: @talk.event_id, name: @talk.name }
    assert_redirected_to talk_path(assigns(:talk))
  end
