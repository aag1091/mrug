...
class HacksControllerTest < ActionController::TestCase
  ...
  test "should create hack" do
    assert_difference('Hack.count') do
      post :create, hack: { description: @hack.description, title: @hack.title, user_id: @hack.user_id }
    end
  ...
  test "should update hack" do
    patch :update, id: @hack, hack: { description: @hack.description, title: @hack.title, user_id: @hack.user_id }
    assert_redirected_to hack_path(assigns(:hack))
  end
